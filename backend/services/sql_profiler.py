...
class SQLProfiler:
    ...
    def profile_query(self, query: str, stream: Optional[bool] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            total_time_ms = round((db_execution_time_ms or 0.0) + conversion_time_ms, 2)
    ...
    def compare_queries(self, original_query: str, optimized_query: str) -> Dict[str, Any]:
        try:
            ...
            memory_improvement = original_result.get("memory_used_mb", 0.0) - optimized_result.get(
                "memory_used_mb", 0.0
            )
            ...
            comparison = {
                ...
                "improvements": {
                    ...
                    "memory_saved_mb": round(memory_improvement, 2),
            ...
            logger.info("Query comparison done: %.2f%% time improvement", time_improvement_percent)
            return comparison
